...
extern mf_status tf_parse_cb_forward(void *user_data,
                                     const void *file_data, size_t file_size);

extern mf_status tf_parse_cb_backward(void *user_data,
                                      const void *file_data,
                                      size_t file_size);

extern mf_status tf_parse_file(const char *filename, void *user_data,
